...
CREATE TABLE `T_COMPANY_HISTORY_DATA` (
  ...
  PRIMARY KEY (`FCOMPANY_ID`,`FDATETIME`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

/*Data for the table `T_COMPANY_HISTORY_DATA` */

insert  into `T_COMPANY_HISTORY_DATA`(`FCOMPANY_ID`,`FDATETIME`,`FPH`,`FEMISSION_LOAD`) values 
...
insert  into `T_COMPANY_REALTIME_DATA`(`FCOMPANY_ID`,`FSTATUS`,`FPH`,`FEMISSION_LOAD`,`FLMODIFY`) values 
(1,1,7,109.9,'2018-01-03 21:54:15');
